## ---------------------------
##
## Statistical matching for sensitivity analysis
##
...
## using match2C. Exposure based sensitivity analysis match.
##   
## ---------------------------
...
# 'Exposure' for statistical matching is no hospital-level TEE.
cabg$exposure <- ifelse(cabg$TEE == 1, 0, 1)
...
# Fit a propensity score model. Excluding exact and fine balance vars?
attach(cabg16)
...
#Save matched data
dir.create("./Sensitivity_match_output")
write_csv(dt16_matched, "./Sensitivity_match_output/dt16_matched_sa.csv")
write_csv(dt17_matched, "./Sensitivity_match_output/dt17_matched_sa.csv")
write_csv(dt18_matched, "./Sensitivity_match_output/dt18_matched_sa.csv")
write_csv(dt19_matched, "./Sensitivity_match_output/dt19_matched_sa.csv")
write_csv(tb_after_match16, "./Sensitivity_match_output/tb_after_match16_sa.csv")
write_csv(tb_after_match17, "./Sensitivity_match_output/tb_after_match17_sa.csv")
write_csv(tb_after_match18, "./Sensitivity_match_output/tb_after_match18_sa.csv")
write_csv(tb_after_match19, "./Sensitivity_match_output/tb_after_match19_sa.csv")
